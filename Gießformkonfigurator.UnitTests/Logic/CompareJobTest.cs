...
namespace Gießformkonfigurator.UnitTests.Logic
{
    ...
    {
        [TestMethod]
        public void CompareDiscProduct_()
        {
            // Arrange
            var product = new ProductDisc()
            {
                ID = 000,
            ...
            var modularMold = new ModularMold(baseplate, ring, insertPlate, core);
            ...
            compareJob.modularMolds.Clear();
            compareJob.singleMoldDiscs.Clear();

            compareJob.modularMolds.Add(modularMold);
            ...
            // Assert
            Assert.IsNotNull(compareJob.compareJobOutput);       
